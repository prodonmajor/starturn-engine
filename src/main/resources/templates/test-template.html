        ...
        <div>
            <table id="report" class="report" border="2">
                <tr>
                    ...
                    <th>Transaction Interest Amount</th>
                    <th>message</th>
                </tr>
                <#list report as r>
                <tr>
                    <td>${r.cooperativeId}</td>
                    <td>${r.memberProfileId}</td>
                    <td>${r.profileFirstName}</td>
                    <td>${r.profileLastName}</td>
                    <td>${r.amount}</td>
                    <td>${r.interest}</td>
                    <td>${r.informationOnSuspension}</td>
                </tr>
                </#list>
            </table>
        </div>
